...
public class App {
	...
	public static void main(String[] args) {
		...
		CRUDService<String, BankUserDTO> userService = new BankUserCRUDService();
		CRUDService<String, AccountDTO> accountService = new AccountCRUDService();
		CRUDService<String, TransactionDTO> TrasactionService = new TransactionCRUDService();
